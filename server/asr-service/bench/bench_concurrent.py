...
用法：
  ...
  python -m grpc_tools.protoc -I server/asr-service/proto \\
      --python_out=server/asr-service/bench \\
      --grpc_python_out=server/asr-service/bench \\
      server/asr-service/proto/asr.proto

  # 2) 跑压测：
  python server/asr-service/bench/bench_concurrent.py \\
