...
```text
amphion-runtime/tools/tts/trial-export/lits_delivery_16k_hifigan/1.0.0/
```
...
注意：模型文件只需要放到 `tools/tts/trial-export/...`，不要手动放到 `sdk/src/main/assets/...`；Gradle 会在 `preBuild` 阶段自动同步。
