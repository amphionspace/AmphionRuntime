...
class LitsTtsFrontendTest {
    ...
    private fun testLayout(): LitsTtsAssetInstaller.InstalledLayout {
        ...
        val assetRoot = listOf(
            File("src/main/assets/lits-models/tts/lits_delivery_16k_hifigan/1.0.0"),
            File("sdk/src/main/assets/lits-models/tts/lits_delivery_16k_hifigan/1.0.0"),
        ).firstOrNull { it.isDirectory }
            ?: error("TTS asset directory not found from test working directory")
