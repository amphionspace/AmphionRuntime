...
import com.yourco.asr.Cancellable
import com.yourco.asr.ModelDescriptor
import com.yourco.asr.ModelDownloadCallback
import com.yourco.asr.ModelFile
import java.io.File
...
internal class ModelDownloader(private val appCtx: Context) {
    ...
    private fun downloadOne(file: ModelFile, dst: File, onProgress: (Long) -> Unit) {
        ...
        val conn = (URL(file.url).openConnection() as HttpURLConnection).apply {
            ...
            setRequestProperty("User-Agent", "AsrSdk/${com.yourco.asr.BuildConfig.SDK_VERSION}")
        }
