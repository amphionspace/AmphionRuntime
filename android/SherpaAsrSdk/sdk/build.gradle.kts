...
val sdkGroupId: String = providers.gradleProperty("ASR_SDK_GROUP_ID").get()
val sdkArtifactId: String = providers.gradleProperty("ASR_SDK_ARTIFACT_ID").get()
val sdkVersion: String = providers.gradleProperty("ASR_SDK_VERSION").get()

android {
    namespace = "com.yourco.asr"
    compileSdk = 34
    ...
    kotlinOptions {
        ...
        // 不带显式 public/internal 标注；我们自己 com.yourco.asr.* 的可见性靠 KDoc + 代码审查保证。
        ...
        publications {
            create<MavenPublication>("release") {
                ...
                pom {
                    ...
                    description.set("Android ASR SDK based on sherpa-onnx (streaming Zipformer Transducer)")
                    licenses {
                        license {
                            name.set("Apache-2.0")
