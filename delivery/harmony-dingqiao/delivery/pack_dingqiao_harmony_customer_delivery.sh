...
VERSION="${AMPHION_RUNTIME_VERSION:-0.3.14}"
...
RELEASE_INPUTS=(
  ...
  delivery/harmony-dingqiao/docs/customer/UPGRADE_0.3.14.md
...
if [[ "$SDK_ONLY" == true ]]; then
  ...
  cp -v "$REPO_ROOT/delivery/harmony-dingqiao/docs/customer/UPGRADE_0.3.14.md" \
    "$OUT_ROOT/docs/UPGRADE_0.3.14.md"
...
| `docs/UPGRADE_0.3.14.md` | 相对上一正式交付的接口、角色分离、生命周期与冷启动变化 |
