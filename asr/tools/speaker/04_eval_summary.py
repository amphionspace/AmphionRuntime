...
用法：
    ...
    python asr/tools/speaker/04_eval_summary.py \
        --jsonl asr/tools/speaker/results/eval_sanity.jsonl \
        --out-json asr/tools/speaker/results/eval_sanity_summary.json \
        --out-md   asr/tools/speaker/results/eval_sanity_summary.md
"""
