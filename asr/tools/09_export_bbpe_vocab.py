...
用法：
  python asr/tools/09_export_bbpe_vocab.py \
    asr/tools/demo-model/zipformer_L_zh_en/bbpe.model \
    asr/tools/demo-model/zipformer_L_zh_en/bbpe.vocab

  或者批量：
  python asr/tools/09_export_bbpe_vocab.py --batch asr/tools/demo-model
"""
...
try:
    ...
    print(
        ...
        "  .venv-tools/bin/python asr/tools/09_export_bbpe_vocab.py ...",
        file=sys.stderr,
    )
    sys.exit(1)
