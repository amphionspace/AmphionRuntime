...
#
# 用法：
#   bash asr/tools/00_fetch_demo_model.sh                    # 仅下载 + 重命名 + 生成 manifest
#   bash asr/tools/00_fetch_demo_model.sh push               # 同上，再用 adb push 到设备
#   bash asr/tools/00_fetch_demo_model.sh push <serial>      # 指定 adb 设备序列号
#
...
OUT_ROOT="$REPO_ROOT/asr/tools/demo-model"
...
[NEXT] 如果你想现在 push 到测试设备：
       ...
       或者带设备序列号：
         ...
         bash asr/tools/00_fetch_demo_model.sh push <adb-serial>
