...
适用 SDK 版本：0.2.x 起（SDK 端实现见 `android/AmphionRuntime/sdk/src/main/java/com/amphion/asr/internal/LicenseVerifier.kt`）。
...
输出的公钥 base64 贴到 `android/AmphionRuntime/gradle.properties`：
