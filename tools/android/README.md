...
```bash
bash tools/android/<script>.sh [交付版本号]
```

交付版本号省略时 = `android/AmphionRuntime/gradle.properties` 的 `AMPHION_RUNTIME_VERSION`。
...
溯源逻辑见 `android/AmphionRuntime/docs/DINGQIAO_DELIVERY.md` §4.1。
