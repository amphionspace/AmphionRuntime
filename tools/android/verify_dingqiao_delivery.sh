...
#
# 用法:
#   bash tools/android/verify_dingqiao_delivery.sh path/to/VERSION.txt
#   bash tools/android/verify_dingqiao_delivery.sh path/to/dingqiao-asr-v*.aar
#   bash tools/android/verify_dingqiao_delivery.sh path/to/amphion-dingqiao-*-customer/
set -euo pipefail
