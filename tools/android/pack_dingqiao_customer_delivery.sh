...
#   bash tools/android/pack_dingqiao_customer_delivery.sh [交付版本号]
#
...
dingqiao_write_version_txt "$OUT_ROOT/VERSION.txt" \
  ...
  "pack_script=tools/android/pack_dingqiao_customer_delivery.sh"
...
----
  ...
  - 校验: bash tools/android/verify_dingqiao_delivery.sh VERSION.txt
EOF
