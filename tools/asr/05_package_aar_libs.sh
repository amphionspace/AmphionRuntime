...
#
# 用法：
#   bash tools/asr/05_package_aar_libs.sh                  # 拷已经存在的全部 ABI
#   bash tools/asr/05_package_aar_libs.sh arm64-v8a
#   bash tools/asr/05_package_aar_libs.sh all
#
...
SDK_JNI_LIBS_DIR="$REPO_ROOT/android/AmphionRuntime/sdk/src/main/jniLibs"
...
echo "[NEXT] 进 android/AmphionRuntime 执行："
