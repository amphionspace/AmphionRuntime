...
#   bash tools/asr/04_build_android_so.sh                  # 默认编 arm64-v8a
#   bash tools/asr/04_build_android_so.sh arm64-v8a
#   bash tools/asr/04_build_android_so.sh armeabi-v7a
#   bash tools/asr/04_build_android_so.sh all              # 都编
#
# 前置：
...
echo
echo "[DONE] 接下来运行 tools/asr/05_package_aar_libs.sh 把 .so 拷到 SDK 工程。"
