...
│   ├── evaluation/              # ASR 车牌、警务术语、声纹评测工装与协议
...
│   └── tools/                   # 模型导出 / 量化 / 编译 / 打包 / macOS 环境准备工具
│
├── tts/                         # TTS 能力纵切
...
仓库没有单一的整库版本号。ASR、TTS 及各平台交付节奏不同，分别以对应构建配置为准；当前源码中的版本如下：

| 能力 / 平台 | 当前版本 | 权威来源 |
| --- | --- | --- |
| ASR Android | `0.3.7` | [asr/android/gradle.properties](asr/android/gradle.properties) `AMPHION_RUNTIME_VERSION` |
| ASR HarmonyOS | `0.3.16` | [asr/harmony/sdk/oh-package.json5](asr/harmony/sdk/oh-package.json5) `version` |
