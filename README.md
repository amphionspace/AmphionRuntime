...
| 能力 / 平台 | 当前版本 | 权威来源 |
| --- | --- | --- |
| ASR Android | `0.3.6` | [asr/android/gradle.properties](asr/android/gradle.properties) `AMPHION_RUNTIME_VERSION` |
| ASR HarmonyOS | `0.3.15` | [asr/harmony/sdk/oh-package.json5](asr/harmony/sdk/oh-package.json5) `version` |
