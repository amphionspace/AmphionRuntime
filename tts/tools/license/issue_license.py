...
def main() -> None:
    ap = argparse.ArgumentParser(description="签发 Lits TTS 离线 license（.lic）")
    ...
    ap.add_argument(
        "--features", default="", help="逗号分隔的功能模块，如 TTS_ZH_EN,TTS_EN_US",
    )
    ...
    print("     交付给业务方放进 app 的 assets/（默认文件名 lits-tts-license.lic）。")
