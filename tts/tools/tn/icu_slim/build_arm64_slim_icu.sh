...
# aarch64 / OHOS, using the same verified filter (tts/tools/tn/icu_tn_data_filter.json).
#
...
FILTER="$REPO/tts/tools/tn/icu_tn_data_filter.json"
...
echo ">> then:  SLIM_ICU_LIB_DIR=$STAGE OHOS_NATIVE_SDK=$OHOS_NATIVE_SDK tts/tools/tn/build_dingqiao_harmony_tn.sh"
