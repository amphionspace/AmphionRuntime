...
2. 本地已经可以测训练侧流式指标：
   - `infer/benchmark_streaming_local.py`（训练仓库参考脚本）
...
`tts/android/sdk/src/main/java/com/lits/tts/sdk/internal/LitsTtsOrtRuntime.kt`
...
`tts/android/sdk/src/main/java/com/lits/tts/sdk/internal/TextToSpeechEngineImpl.kt`
...
`LitsTtsSdk/tools/export_lits_delivery_16k_hifigan_onnx.py`
...
`train/lits/models/components/flow_matching.py`
...
`train/lits/models/components/transformer.py`
...
`tts/android/sdk/src/main/java/com/lits/tts/sdk/internal/LitsTtsAssetInstaller.kt`
...
`tts/android/sdk/src/main/java/com/lits/tts/sdk/internal/LitsTtsAssetRegistry.kt`
...
`tts/android/sdk/src/main/java/com/lits/tts/sdk/internal/PcmSynthesizer.kt`
...
以 `infer/benchmark_streaming_local.py`（训练仓库参考脚本）为基线，至少对比：
...
1. `LitsTtsSdk/tools/export_lits_delivery_16k_hifigan_onnx.py`
2. `tts/android/sdk/src/main/java/com/lits/tts/sdk/internal/LitsTtsOrtRuntime.kt`
3. `tts/android/sdk/src/main/java/com/lits/tts/sdk/internal/PcmSynthesizer.kt`
4. `tts/android/sdk/src/main/java/com/lits/tts/sdk/internal/TextToSpeechEngineImpl.kt`
5. `tts/android/sdk/src/main/java/com/lits/tts/sdk/internal/LitsTtsAssetInstaller.kt`
